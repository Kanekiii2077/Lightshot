    ...
    <body>
        <div id="overlay" class="overlay">
            <div class="overlay-body">
                ...
                <p class="overlay-description">Этот сайт использует файлы cookie, чтобы предложить вам наиболее актуальную информацию и
                                               лучше понять, как вы используете этот сайт. Пожалуйста, примите файлы cookie для
                                               оптимальной работы.</p>
